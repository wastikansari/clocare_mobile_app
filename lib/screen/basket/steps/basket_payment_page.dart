...
class BasketPaymentPage extends StatefulWidget {
  final String amount;
  ...
  @override
  State<BasketPaymentPage> createState() => _BasketPaymentPageState();
}

class _BasketPaymentPageState extends State<BasketPaymentPage> {
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              BoxWidget(
                                ...
                                onTap: () {
                                  setState(() {
                                    selectDeliveryIndex = 3;
                                    selectPayType = "Pay on Pickup";
                                  });
                                  sendDataToParent();
                                },
                                textColor: selectDeliveryIndex == 3
                                    ? AppColor.backgroundColor
                                    : AppColor.appBarColor,
                                bg: selectDeliveryIndex == 3
                                    ? AppColor.primaryColor1Greey
                                    : const Color.fromARGB(106, 239, 241, 254),
                              ),
                            ],
